...
#define MP3_IN_SIZE   (324)   //576->改到324解决末尾吞音问题
...
int32_t audio_play_opus_init(void)
{
    mprintf("audio_play_opus_init...\r\n");
    return 0;
}
int32_t audio_play_opus_decode(uint8_t * input, uint32_t in_size, short *output,uint32_t *out_size, uint32_t *no_use_size,audio_format_info_t *audio_format_info)
{
    mprintf("audio_play_opus_decode...\r\n");
    return 0;
}
int32_t audio_play_opus_clear(void)
{
    mprintf("audio_play_opus_clear...\r\n");
    return 0;
}
int32_t audio_play_opus_destroy(void)
{
    mprintf("audio_play_opus_destroy...\r\n");
    return 0;
}
/**
 * @brief opus解码器结构对象
 * 
 */
audio_play_decoder_ops_t opus_decoder =
{
    .decoder_name = "opus",
    .init = audio_play_opus_init,
    .decode = audio_play_opus_decode,

    .load = NULL,
    .save = NULL,
    .config = NULL,
    .clear = audio_play_opus_clear,
    .destroy = audio_play_opus_destroy,
    .data_in_size = 80,
    .next_ops = NULL,
};

...
#include "mp3dec.h"
#include "mp3statname.h"	/* do name-mangling for static linking */
...
extern int (* samplerateTab)[3];
extern short (* bitrateTab)[3][15];
extern short (* samplesPerFrameTab)[3];
extern short * bitsPerSlotTab;
extern short (* sideBytesTab)[2];
extern short (* slotTab)[3][15];
extern SFBandTable (* sfBandTable)[3];
#else
/* mp3tabs.c - global ROM tables */

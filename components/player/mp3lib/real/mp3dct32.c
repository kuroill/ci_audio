 ...
 * June 2003
 *
 * mp3dct32.c - optimized implementations of 32-point DCT for matrixing stage of 
 *             polyphase filter
 **************************************************************************************/
...
_DIF_ static const int dcttab[48] = {
	/* first pass */
 ...
 *                enough registers)
 **************************************************************************************/
_XIF_  void FDCT32(int *buf, int *dest, int offset, int oddBlock, int gb)
{
    int i, s, tmp, es;

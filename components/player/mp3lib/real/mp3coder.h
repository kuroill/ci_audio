 ...
 * June 2003
 *
 * mp3coder.h - private, implementation-specific header file
 **************************************************************************************/
...
/* mp3dequant.c, mp3dqchan.c, mp3stproc.c */
...
/* mp3hufftabs.c */
extern HuffTabLookup * huffTabLookup;
extern int * huffTabOffset;
extern unsigned short * huffTable_0;
extern unsigned short * huffTable_1;
extern unsigned short * huffTable_2;
extern unsigned char * quadTable;
extern int * quadTabOffset;
extern int * quadTabMaxBits;
#else
/* mp3hufftabs.c */
extern const HuffTabLookup huffTabLookup[HUFF_PAIRTABS];
extern const int huffTabOffset[HUFF_PAIRTABS];
extern const unsigned short huffTable_0[];
extern const unsigned short huffTable_1[];
extern const unsigned short huffTable_2[];
...
#ifdef USE_OUTSIDE_MP3_TABLE
/* mp3trigtabs.c */
extern int (* imdctWin)[36];
extern int (* ISFMpeg1)[7];
extern int (* ISFMpeg2)[2][16];
extern int (* ISFIIP)[2];
extern unsigned char * uniqueIDTab;
extern int (* csa)[2];
extern int * coef32;
extern int * polyCoef;
#else

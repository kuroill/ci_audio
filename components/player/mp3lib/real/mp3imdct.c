 ...
 * June 2003
 *
 * mp3imdct.c - antialias, inverse transform (short/long/mixed), windowing, 
 ...
 **************************************************************************************/
_XIF_  static void AntiAlias(int *x, int nBfly)
{
	int k, a0, b0, c0, c1;
	const int *c;
 ...
 **************************************************************************************/
_XIF_  static void WinPrevious(int *xPrev, int *xPrevWin, int btPrev)
{
 ...
 **************************************************************************************/
_XIF_  static int FreqInvertRescale(int *y, int *xPrev, int blockIdx, int es)
{
	int i, d, mOut;
 ...
 * float c4 = sin(2*u);
 */
_DIF_ static const int c9_0 = 0x6ed9eba1;
_DIF_ static const int c9_1 = 0x620dbe8b;
_DIF_ static const int c9_2 = 0x163a1a7e;
_DIF_ static const int c9_3 = 0x5246dd49;
_DIF_ static const int c9_4 = 0x7e0e2e32;

/* format = Q31
 * cos(((0:8) + 0.5) * (pi/18)) 
 */
_DIF_ static const int c18[9] = {
 ...
 * format = Q30
 */
_DIF_ static const int fastWin36[18] = {
 ...
 **************************************************************************************/
_XIF_  static int IMDCT36(int *xCurr, int *xPrev, int *y, int btCurr, int btPrev, int blockIdx, int gb)
{
...
_DIF_ static const int c3_0 = 0x6ed9eba1;	/* format = Q31, cos(pi/6) */
_DIF_ static const int c6[3] = { 0x7ba3751d, 0x5a82799a, 0x2120fb83 };	/* format = Q31, cos(((0:2) + 0.5) * (pi/6)) */

/* 12-point inverse DCT, used in IMDCT12x3() 
 * 4 input guard bits will ensure no overflow
 */
_XIF_  static void imdct12 (int *x, int *out)
{
	int a0, a1, a2;
 ...
 **************************************************************************************/
_XIF_  static int IMDCT12x3(int *xCurr, int *xPrev, int *y, int btPrev, int blockIdx, int gb)
{
 ...
 **************************************************************************************/
_XIF_  static int HybridTransform(int *xCurr, int *xPrev, int y[BLOCK_SIZE][NBANDS], SideInfoSub *sis, BlockCount *bc)
{

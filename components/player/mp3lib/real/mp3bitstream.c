 ...
 * June 2003
 *
 * mp3bitstream.c - bitstream unpacking, frame header parsing, side info parsing
 **************************************************************************************/
 ...
 * Return:      none
 **************************************************************************************/
_XIF_  void SetBitstreamPointer(BitStreamInfo *bsi, int nBytes, unsigned char *buf)
{
	/* init bitstream */
	bsi->bytePtr = buf;
 ...
 **************************************************************************************/
_XIF_  static void RefillBitstreamCache(BitStreamInfo *bsi)
{
 ...
 * TODO:        optimize for ARM
 **************************************************************************************/
_XIF_  unsigned int GetBits(BitStreamInfo *bsi, int nBits)
{
 ...
 **************************************************************************************/
_XIF_  int CalcBitsUsed(BitStreamInfo *bsi, unsigned char *startBuf, int startOffset)
{
	int bitsUsed;

 ...
 * June 2003
 *
 * mp3polyphase.c - final stage of subband transform (polyphase synthesis filter)
 *
...
#if ((!defined(PolyphaseMono)) || (!defined(PolyphaseStereo)))
...
_XIF_  static short ClipToShort(int x, int fracBits)
{
	int sign;
